...
assert g.players[1].money == 7,"Player 2 Incorrect CP's after Turn 1"
print("\n       Passed")
...
print("\n       Testing Player 1 Money")
assert h.players[0].money == 7,"Player 1 Incorrect CP's after Turn 1"
print("\n       Passed")

print("\n       Testing Player 2 Money")
assert h.players[1].money == 1,"Player 2 Incorrect CP's after Turn 1"
print("\n       Passed")
...
p1_scouts = [scout for scout in h.players[0].game_data[(2,2)] if scout.unit_type == "Scout" and scout.team == 1]
assert len(p1_scouts) == 1,"Player 1 Incorrect Scouts at (2,2)"
print("\n       Passed")
